...
export const Card = observer(
  ({ image, title, subtitle, content, onClick }: CardProps): JSX.Element => {
    ...
    const renderedContent = searchStore.isSearchOn ? (
      <footer>
        <p className={styles.card_rank}>
    ...
    return (
      <article className={styles.card} onClick={onClick}>
        ...
        {!searchStore.isSearchOn && renderedGraph}
